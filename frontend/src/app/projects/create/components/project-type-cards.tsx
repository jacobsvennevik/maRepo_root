...
export function ProjectTypeCards({ onProjectTypeSelect }: ProjectTypeCardsProps) {
  return (
    <div className="grid md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-6xl mx-auto">
      ...
      <Card className="relative overflow-hidden border-2 hover:border-purple-300 transition-all duration-300 hover:shadow-lg group cursor-pointer"
            onClick={() => onProjectTypeSelect('self-study')}>
        ...
        <CardHeader className="relative">
          ...
          <CardTitle className="text-lg sm:text-xl text-slate-900">Self-Study Project</CardTitle>
        </CardHeader>
        <CardContent className="relative">
          <p className="text-sm sm:text-base text-slate-600 mb-3 sm:mb-4">
            Create a personal learning project for skill development and self-improvement.
          </p>
      ...
      <Card className="relative overflow-hidden border-2 hover:border-blue-300 transition-all duration-300 hover:shadow-lg group cursor-pointer"
            onClick={() => onProjectTypeSelect('school')}>
        ...
        <CardHeader className="relative">
          ...
          <CardTitle className="text-lg sm:text-xl text-slate-900">School Project</CardTitle>
        </CardHeader>
        <CardContent className="relative">
          <p className="text-sm sm:text-base text-slate-600 mb-3 sm:mb-4">
            Create a project for academic coursework, classes, or educational assignments.
          </p>
          <div className="space-y-1 sm:space-y-2 text-xs sm:text-sm text-slate-500 mb-4 sm:mb-6">
            <div className="flex items-center">
      ...
      <Card className="relative overflow-hidden border-2 border-gray-200 opacity-75">
        ...
        <CardHeader className="relative">
          ...
          <CardTitle className="text-lg sm:text-xl text-slate-900">Group Collaboration</CardTitle>
        </CardHeader>
        <CardContent className="relative">
          <p className="text-sm sm:text-base text-slate-600 mb-3 sm:mb-4">
            Create collaborative learning projects with teams, study groups, and shared resources.
          </p>
          <div className="space-y-1 sm:space-y-2 text-xs sm:text-sm text-slate-500 mb-4 sm:mb-6">
            <div className="flex items-center">
          ...
          <div className="mt-4 sm:mt-6">
            <Button disabled className="w-full text-sm sm:text-base cursor-not-allowed">
              Coming Soon
            </Button>
          </div>
        </CardContent>
