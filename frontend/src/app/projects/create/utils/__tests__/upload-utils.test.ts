...
describe('upload-utils', () => {
  ...
  describe('uploadFileToService', () => {
    ...
    it('should handle upload errors', async () => {
      ...
      await expect(uploadFileToService(mockFile, 'course_files')).rejects.toThrow('Upload failed: 400 Bad Request');
    });
    ...
    it('should handle network errors', async () => {
      ...
      await expect(uploadFileToService(mockFile, 'course_files')).rejects.toThrow('Network error');
    });
    ...
    it('should handle abort errors', async () => {
      ...
      await expect(uploadFileToService(mockFile, 'course_files')).rejects.toThrow('Upload was cancelled');
    });
  ...
  describe('startDocumentProcessing', () => {
    ...
    it('should handle processing errors', async () => {
      ...
      await expect(startDocumentProcessing(1)).rejects.toThrow('Processing failed: 500 Internal Server Error');
    });
    ...
    it('should handle abort errors during processing', async () => {
      ...
      await expect(startDocumentProcessing(1)).rejects.toThrow('Processing was cancelled');
    });
  ...
  describe('error handling edge cases', () => {
    it('should handle malformed JSON responses', async () => {
      ...
      await expect(uploadFileToService(mockFile, 'course_files')).rejects.toThrow('Invalid JSON');
    });
