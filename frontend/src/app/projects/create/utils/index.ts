  ...
  switch (stepId) {
    ...
    case "assignmentDescription":
      return setup.purpose === "school"
        ? !!setup.assignmentDescription || setup.courseFiles.length > 0
        : true;
    ...
    case "testUpload":
      return setup.purpose === "school"
        ? setup.selectedTestTypes.length > 0 || setup.testFiles.length > 0
        : true;
    case "importantDates":
      return setup.purpose === "school"
...
export const shouldShowStep = (
  ...
  if (
    stepId === "assignmentDescription" ||
    stepId === "evaluationTypes" ||
    stepId === "testUpload" ||
    stepId === "importantDates"
  ) {
    return setup.purpose === "school";
  }
  return true;
