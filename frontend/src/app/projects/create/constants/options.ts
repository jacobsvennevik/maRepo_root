...
export const SCHOOL_PURPOSE_OPTIONS: PurposeOption[] = [
  { value: 'good-grades', label: 'Get Good Grades', description: 'Improve my academic performance' },
  { value: 'exam-prep', label: 'Exam Preparation', description: 'Prepare for an upcoming test or exam' },
  { value: 'homework-help', label: 'Homework Help', description: 'Get help with assignments' },
  { value: 'deeper-understanding', label: 'Deeper Understanding', description: 'Gain a more thorough grasp of a subject' },
  { value: 'custom', label: 'Other', description: 'Something else - I\'ll describe it myself' }
];
