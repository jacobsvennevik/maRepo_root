...
export const PURPOSE_OPTIONS: PurposeOption[] = [
  ...
  },
  {
    value: "career-change",
    label: "Career Change",
    description: "Learning new skills for a career transition",
  },
  {
    value: "hobby",
    label: "Hobby/Interest",
    description: "Learning for personal enjoyment",
  },
  {
    value: "certification",
    label: "Certification",
    description: "Preparing for a professional certification",
  },
  {
    value: "custom",
    label: "Other",
...
export const FOCUS_AREA_OPTIONS: FocusAreaOption[] = [
  ...
  // Custom
  {
    ...
    description: "Add your own focus area",
    icon: Plus,
    category: "Custom",
  },
];
