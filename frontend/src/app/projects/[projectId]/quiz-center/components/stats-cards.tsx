...
export function StatsCards({ totalTests, completedTests, averageScore }: StatsCardsProps) {
  const stats = [
    { title: 'Total Quizzes', value: totalTests, icon: Target, color: 'from-blue-400 to-blue-600' },
