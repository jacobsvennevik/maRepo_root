...
export function LearningJourney({
  ...
  const learningJourney: JourneyItem[] = [
    {
      id: 1,
      milestone: "Completed Ocean Biology Quiz",
      time: "2 hours ago",
      type: "quiz",
      status: "completed",
    },
    {
      id: 2,
      milestone: "Discovered 5 new concepts",
      time: "4 hours ago",
      type: "discovery",
      status: "explored",
    },
    {
      id: 3,
      milestone: "Updated navigation charts",
      time: "1 day ago",
      type: "notes",
      status: "updated",
    },
    {
      id: 4,
      milestone: "Set sail for new chapter",
      time: "2 days ago",
      type: "chapter",
      status: "started",
    },
            ...
            <div
              ...
              style={{
                ...
                transform: floatingCards
                  ? `translateX(${Math.sin(waveOffset * 0.05 + index) * 3}px)`
                  : "translateX(0)",
              }}
            >
