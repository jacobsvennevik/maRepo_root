      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card
          ...
          style={{
            ...
            transform: floatingCards
              ? `translateY(${Math.sin(waveOffset * 0.1) * 5}px)`
              : "translateY(0)",
          }}
        >
        ...
        <Card
          ...
          style={{
            animationDelay: "0.2s",
            transform: floatingCards
              ? `translateY(${Math.sin(waveOffset * 0.1 + 1) * 5}px)`
              : "translateY(0)",
          }}
        >
          <CardContent className="p-6">
        ...
        <Card
          ...
          style={{
            animationDelay: "0.4s",
            transform: floatingCards
              ? `translateY(${Math.sin(waveOffset * 0.1 + 2) * 5}px)`
              : "translateY(0)",
          }}
        >
          <CardContent className="p-6">
        ...
        <Card
          ...
          style={{
            animationDelay: "0.6s",
            transform: floatingCards
              ? `translateY(${Math.sin(waveOffset * 0.1 + 3) * 5}px)`
              : "translateY(0)",
          }}
        >
          <CardContent className="p-6">
        ...
        {topics.map((topic, index) => (
          <Card
            ...
            style={{
              ...
              transform: floatingCards
                ? `translateY(${Math.sin(waveOffset * 0.05 + index) * 3}px)`
                : "translateY(0)",
            }}
          >
            <CardHeader className="pb-4">
              <div className="flex items-center justify-between">
                <CardTitle className="flex items-center gap-2 text-lg">
                  <div
                    className={`p-2 rounded-lg bg-gradient-to-r ${topic.color} shadow-md`}
                  >
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-slate-900">
                    {topic.mastered}/{topic.cardCount}
                  </span>
                </div>
                <Progress
