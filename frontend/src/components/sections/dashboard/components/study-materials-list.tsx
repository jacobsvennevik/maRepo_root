    ...
    <div className="bg-white rounded-lg p-6 shadow-sm">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-xl font-medium text-slate-900">
          Your Recent Study Materials
        </h3>
        <Button
          variant="ghost"
          className="text-[#47B5FF] flex items-center p-0 h-auto hover:bg-transparent hover:text-blue-600"
        >
        ...
        <div className="py-4">
          ...
          <div className="mt-3 ml-16 space-y-3">
            ...
            <p className="text-sm text-slate-600">
              Comprehensive study notes covering advanced cellular biology
