    ...
    <section id="pricing" className="relative py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex items-center justify-center mb-8">
          <span
            className={`mr-3 text-sm ${annual ? "text-slate-900 font-medium" : "text-slate-600"}`}
          >
            Annual Billing
          </span>
          <button
          ...
          <span
            className={`ml-3 text-sm ${!annual ? "text-slate-900 font-medium" : "text-slate-600"}`}
          >
            Monthly Billing
          </span>
          {annual && (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-slate-200 transition-transform hover:shadow-xl hover:-translate-y-1">
            <div className="p-8">
              ...
              <div className="mb-6">
                <span className="text-4xl font-bold text-slate-900">
                  ${enterprisePrice.monthly}
                </span>
                <span className="text-slate-600 ml-1">/month</span>
                {enterprisePrice.original && (
                  <div className="mt-1">
                    <span className="text-sm text-slate-500 line-through">
                      ${enterprisePrice.original}/month
                    </span>
                    <span className="ml-2 text-xs font-medium bg-emerald-100 text-emerald-800 px-1.5 py-0.5 rounded-full">
        ...
        <div className="mt-24 max-w-5xl mx-auto">
          <h3 className="text-2xl font-medium text-center text-slate-900 mb-12">
            All Plans Include
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-lg font-medium text-[#06b6d4] mb-2">
                AI-Powered Learning
              </h4>
              <p className="text-slate-600">
                Intelligent algorithms that adapt to your learning style
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-slate-600">
                Learn more efficiently with personalized study paths
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-slate-600">
                Your learning data is always private and secure
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-100">
              ...
              <p className="text-slate-600">
                ...
                upgrade, you'll be charged the prorated difference. If you
                downgrade, you'll receive credit towards your next billing
                cycle.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-100">
              ...
              <p className="text-slate-600">
                Yes! Students with a valid .edu email address can get 50% off
                any paid plan. Contact our support team to verify your student
                status.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-100">
              ...
              <p className="text-slate-600">
                ...
                you're not satisfied with our service, you can request a full
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-100">
              ...
              <p className="text-slate-600">
                ...
                Enterprise plans, we also offer invoicing options.
              </p>
            </div>
          </div>
        </div>
