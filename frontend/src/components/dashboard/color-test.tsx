  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="p-4 border-2 border-aqua rounded-md">border-aqua</div>

        <div className="p-4 text-aqua font-bold rounded-md">text-aqua</div>

        <div className="p-4 text-ocean font-bold rounded-md">text-ocean</div>
      </div>
    </div>
  );
}
