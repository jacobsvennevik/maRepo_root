      ...
      {connections.map((connection) => (
        <div key={connection.name} className="flex items-center gap-1.5">
          <Avatar className="h-6 w-6">
            ...
            <AvatarFallback className="text-[10px]">{connection.initials}</AvatarFallback>
          </Avatar>
          ...
          <div className="flex gap-0.5">
            <Button variant="ghost" size="icon" className="h-5 w-5 text-ocean hover:bg-ocean-50 hover:text-ocean-700">
