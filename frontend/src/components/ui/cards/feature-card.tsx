...
export function FeatureCard({
  ...
  return (
    <div
      id={id}
      className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center mb-24 pt-16"
    >
      {/* Text content - column ordering changes based on reverse prop */}
      <div 
        className={`
          max-w-lg 
          ${reverse ? "lg:col-start-9 lg:col-end-13 lg:pl-6" : "lg:col-span-4 lg:pr-6"}
          order-2 
      ...
      {/* Image content - column ordering changes based on reverse prop */}
      <div 
        className={`
          bg-white rounded-xl shadow-xl overflow-hidden transform transition-transform hover:scale-102
          ${reverse ? "lg:col-start-1 lg:col-end-9" : "lg:col-span-8"}
          order-1
