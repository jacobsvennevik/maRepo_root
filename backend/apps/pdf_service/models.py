...
class SyllabusDetails(BaseModel):
    ...
    exams: List[str] = Field([], description="List of exams with their dates and details.")
    tests: List[str] = Field([], description="List of tests with their dates and details.")
    projects: List[str] = Field([], description="List of projects with their due dates and details.")
