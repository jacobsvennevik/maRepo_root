import pytest
from maProject.apps.generation.models import Flashcard, FlashcardSet
from maProject.apps.generation.serializers import FlashcardSerializer, FlashcardSetSerializer
from maProject.apps.accounts.tests.factories import CustomUserFactory
from maProject.apps.generation.tests.factories import FlashcardSetFactory, FlashcardFactory
