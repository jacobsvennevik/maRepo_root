# maProject/apps/generation/tests/test_flashcard_forms.py

import pytest
from maProject.apps.generation.forms import (
    FlashcardForm,
    FlashcardSetForm,
    FlashcardDeleteForm,
    FlashcardFormSet,
...
from .factories import UserFactory, DocumentFactory, FlashcardSetFactory
